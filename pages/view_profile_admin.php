...
$error = $auth->updateProfile($firstname,$lastname,$username,$email, $password, $super_email,$branch_email, $status);
    ...
    $password2 = isset($_POST['oldpassword']) ? $_POST['oldpassword'] : " ";

    $error = $auth->checkPass( $password1, $password2);
}
*/
?>
                    ...
                    <div class="card-body">
                        <div class="account-settings">
                            <div class="user-profile">
                                ...
                                <h8 class="Name "><?php echo $_SESSION[AuthController::$KEY_USER]; ?></h8>
                                <h8 class="user-email"><?php echo $_SESSION[AuthController::$KEY_EMAIL]; ?></h8>
                        ...
                        <div class="row gutters">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="fullname" value="<?php echo getinfo()[1] . " " . getinfo()[2]; ?>">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    <label for="eMail">Email:</label>
                                    <input type="email" class="form-control" id="email" value=<?php echo getinfo()[3]; ?>>
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    <div class = "required-field">Current Password:</div>
                                    <input type="text" class="form-control" id="oldpassword" placeholder="Current password">
                                    <style>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class = "label">Change Role:</div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    <label for="zIp">Last modified date: <?php
                                        echo getInfo()[12];
                                        ?></label>
                                    <input type="text" class="form-control" id="zIp" readonly value="<?php
                        ...
                        <div class="row gutters">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="text-right">
                                    ...
                                    <button type="button" id="submit" name="submit" class="btn btn-secondary" onclick="location.href = 'menu.php'">Cancel</button>
                                    <button type="button" id="submit" name="submit" class="btn btn-secondary"onclick="location.href = 'menu.php'">Update</button>
                                </div>
                            </div>
                        </div>
                    </div>
